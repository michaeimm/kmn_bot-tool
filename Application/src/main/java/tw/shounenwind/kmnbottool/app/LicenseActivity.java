...
public class LicenseActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter listAdapter = new ArrayAdapter(licenses);
    ...
    private void setLicenses() {
        ...
        licenses.add(new License("oauth-signpost", "Apache License\n" +
                "\n" +
    ...
    private class License {
        ...
        License(String title, String content) {
            this.title = title;
    ...
    private class ArrayAdapter extends RecyclerView.Adapter {
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
            ((ListViewHolder)holder).title.setText(data.get(position).title);
            ((ListViewHolder)holder).content.setText(data.get(position).content);
        }
